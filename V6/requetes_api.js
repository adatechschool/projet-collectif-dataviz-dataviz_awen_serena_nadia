...
function obtenirCheminImage(conditionMeteo) {
    switch (conditionMeteo) {
        case "Clear":
            return "sun.svg"; // Afficher une mouette pour un ciel dégagé
        case "Clouds":
            return "clouds.svg"; // Afficher des nuages pour un ciel nuageux
        case "Rain":
            return "rain.svg"; // Afficher de la pluie pour la pluie
        case "Thunderstorm":
            return "storm.svg"; // Afficher un orage pour un orage
        case "Snow":
            return "snow.svg"; // Afficher de la neige pour la neige
        case "Mist":
            return "storm.svg"; // Afficher du brouillard pour le brouillard
        default:
            return "clouds.svg"; // Image par défaut en cas de condition météorologique inconnue
    }
}
